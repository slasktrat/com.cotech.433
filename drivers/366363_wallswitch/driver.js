...
const config = {
	...
	pair: {
		...
		views: [{
				...
				options: {
					...
					prepend: [],
					append: [],
					svg: '../../433_generator/assets/366363_wallswitch/pair.svg',
					svgWidth: '80vw',
					svgHeight: '70vh',
...

			{
				...
				options: {
					svg: '../../433_generator/assets/366363_wallswitch/test.svg',
					prepend: [],
					append: [],
	...
	name: 'devices.366363_wallswitch.name',
	icon: '../../433_generator/assets/366363_wallswitch/icon.svg'
};
